        ...
        if (mGamingFloatingLayout != null && mGamingFBLayoutParams != null) {
            ...
            if (isInPortrait()) {
                setButtonOffset(CoordinateType.X, mGamingFBLayoutParams,
                        mPreferences.getInt(Constants.LocalConfigKeys.FLOATING_BUTTON_COORDINATE_VERTICAL_X, 0));
                setButtonOffset(CoordinateType.Y, mGamingFBLayoutParams,
                        mPreferences.getInt(Constants.LocalConfigKeys.FLOATING_BUTTON_COORDINATE_VERTICAL_Y, 0));
            } else {
                setButtonOffset(CoordinateType.X, mGamingFBLayoutParams,
                        mPreferences.getInt(Constants.LocalConfigKeys.FLOATING_BUTTON_COORDINATE_HORIZONTAL_X, 0));
                setButtonOffset(CoordinateType.Y, mGamingFBLayoutParams,
                        mPreferences.getInt(Constants.LocalConfigKeys.FLOATING_BUTTON_COORDINATE_HORIZONTAL_Y, 0));
            }
